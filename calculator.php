...
<body>
<?php # Script 13.2 - calculator.php  // This script calculates an order total based upon three form values.
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    echo '<p style="font-weight: bold; color: #C00">Please enter a valid quantity, price,
        and tax rate.</p>';
